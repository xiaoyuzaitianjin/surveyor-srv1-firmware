...
SECTIONS
{
    ...
    .l1code         : { main.o(.text) math.o(.text) malloc.o(.text) srv.o(.text) uart.o(.text) colors.o(.text) jpeg.o(.text) r8x8dct.o(.text) spi.o(.text) uart.o(.text) chess.o(.text) setjmp.o(.text)} > l1code
    .l1data         :
    {
