...
SECTIONS
{
    .sdram.text     : { camera.o(.sdram.text) c.o(.sdram.text) lisp.o(.sdram.text) edit.o(.sdram.text) i2c.o(.sdram.text) stm_m25p32.o(.sdram.text) printf.o(.sdram.text) xmodem.o(.sdram.text) chess.o(.sdram.text) *(.gnu.warning) } > ram
